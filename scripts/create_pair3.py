...
(sc_dir / "SubjectsScreen.tsx").write_text("""import React, { useState, useEffect } from 'react';
...
(sc_dir / "AddSubjectScreen.tsx").write_text("""import React, { useState } from 'react';
...
print("Pair 3 written successfully")
