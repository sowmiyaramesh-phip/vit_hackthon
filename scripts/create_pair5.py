...
(sc_dir / "KnowledgeGraphScreen.tsx").write_text("""import React, { useState, useEffect } from 'react';
...
(sc_dir / "Subject360Screen.tsx").write_text("""import React, { useState, useEffect } from 'react';
...
print("Pair 5 written successfully")
